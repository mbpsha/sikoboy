...
const submit = () => {
    ...
    formData.append(
        "nomor_surat",
        `RIW-M/${tahun}/${judulSlug || "KERJASAMA"}`,
    );
    ...
    router.post(route("admin.riwayat-kerjasama.mitra.store"), formData, {
        preserveScroll: true,
        onSuccess: () => {
            ...
            Swal.fire({
                ...
                closeModal();
                router.visit(route('admin.riwayat-kerjasama.mitra'), { preserveState: false });
            });
        },
        onError: (err) => {
            isSubmitting.value = false;
...
<template>
    <AdminLayout title="Riwayat Kerjasama - Mitra" @click="closeAllFilters">
        <div class="p-6">
