    ...
    router.post(route("admin.riwayat-kerjasama.adendum.store"), formData, {
        ...
        onSuccess: () => {
            ...
            Swal.fire({
                ...
                router.visit(route("admin.riwayat-kerjasama.mitra", { page: currentPage }), { preserveState: true });
            });
        },
        onError: (err) => {
        ...
        >
            <div class="bg-white rounded-2xl p-6 w-full max-w-[750px] max-h-[85vh] shadow-lg relative flex flex-col">
                ...
                <div class="overflow-y-auto flex-1 pr-2">
                    ...
                    <!-- TIPE PENGAJUAN (hidden, auto-set to mitra) -->
                    <input type="hidden" v-model="form.tipe_pengajuan" value="mitra" />
