...
const navigation = [
    { name: 'Dashboard', href: route('mitra.dashboard'), current: route().current('mitra.dashboard') },
    { name: 'Profil', href: route('mitra.profile.edit'), current: route().current('mitra.profile.edit') },
];
                ...
                <div class="flex h-16 justify-between">
                    <div class="flex">
                        <div class="flex flex-shrink-0 items-center">
                            <span class="text-xl font-bold text-blue-600">SIKOBOY</span>
                        </div>
