...
<template>
  ...
  <Header />
    ...
    <main class="flex-1 pt-28 sm:pt-32 pb-10 px-4 sm:px-6 md:px-8">
      <div class="max-w-7xl mx-auto">

        <div class="mb-6 sm:mb-8">
          <h1 class="text-2xl sm:text-3xl font-bold text-[#17464E]">Profil Mitra</h1>
          <p class="text-xs sm:text-sm text-[#2f5e66] mt-1">
        ...
        <div v-if="visibleNotifications && visibleNotifications.length > 0" class="mb-6 space-y-3">
          <div 
            ...
            :key="notif.id"
            class="bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-yellow-400 rounded-r-xl p-4 sm:p-5 shadow-md hover:shadow-lg transition-shadow relative"
          >
            ...
            <div class="flex gap-3 sm:gap-4 pr-8">
              <div class="flex-shrink-0">
                <div class="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-yellow-100 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 sm:w-6 h-5 sm:h-6 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                </div>
              </div>
              <div class="flex-1">
                <h4 class="text-xs sm:text-sm font-bold text-yellow-800 mb-1">
                  {{ notif.title }}
                </h4>
        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-6">
          ...
          <!-- Left Sidebar (Mobile: full width, Desktop: 3 cols) -->
          <div class="col-span-12 md:col-span-3 space-y-4 sm:space-y-5">
            <div class="bg-[#E7F0F1] rounded-2xl p-4 sm:p-6 shadow-md">
              <div class="flex items-start gap-3 sm:gap-4">
                <div class="bg-[#2f6f73] p-2 sm:p-3 rounded-xl shadow-sm flex items-center justify-center w-12 sm:w-14 h-12 sm:h-14 shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 sm:w-8 h-6 sm:h-8" viewBox="0 0 24 24" fill="white">
                ...
                <div class="flex flex-col gap-2 flex-1">
                  <h3 class="text-lg sm:text-xl font-bold text-[#17464E] leading-tight mb-1">
                    <Link :href="route('mitra.profile.index')" class="hover:underline">
                      {{ mitra?.nama_perusahaan || 'Hamaz Sejahtera Group' }}
                    </Link>
                  </h3>
                  <span class="inline-block text-xs bg-[#86efac] text-[#166534] px-3 sm:px-4 py-1 rounded-full font-medium w-fit">
                    Aktif
                  </span>
              ...
              <div class="mt-4 sm:mt-5 text-[#40676f]">
                <p class="text-xs sm:text-sm font-medium opacity-70">Alamat</p>
                <p class="text-xs sm:text-sm mt-1 leading-relaxed font-semibold">
                  {{ mitra?.alamat || 'Jl. Jend. Urip Sumoharjo No. 116, Kecamatan Jebres, Jawa Tengah 57128' }}
                </p>
              </div>
            </div>

            <div class="bg-[#E7F0F1] rounded-2xl p-4 sm:p-5 shadow-md">
              <h3 class="text-xs sm:text-sm font-semibold text-[#17464E] mb-3">Statistik</h3>
              <div class="space-y-2 text-xs sm:text-sm text-[#17464E]">
            ...
            <div class="bg-[#E7F0F1] rounded-2xl p-4 sm:p-5 shadow-md">
              <button 
                ...
                class="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 bg-red-500 text-white rounded-xl font-semibold text-sm hover:bg-red-600 transition-all shadow-md hover:shadow-lg"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 sm:w-5 h-4 sm:h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <!-- Right Content (Mobile: full width, Desktop: 9 cols) -->
            ...
            <div class="bg-white rounded-2xl shadow-md overflow-hidden">
              ...
              <div class="flex items-end bg-[#2f6f73]"> 
                <button
                  ...
                  :class="[
                    'flex-1 text-center py-3 sm:py-4 text-xs sm:text-sm font-semibold transition-all duration-300 relative z-10',
                    activeTab === 'pengajuan'
              ...
              <div class="p-4 sm:p-6 md:p-8">
                <div v-show="activeTab === 'pengajuan'">
                  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-5 mb-8 sm:mb-10">
                    <div class="bg-[#DCEBED] p-4 sm:p-5 rounded-2xl shadow-md hover:shadow-lg transition">
                      <div class="flex items-center gap-3 mb-2">
                        <div class="bg-white p-2 rounded-md shadow-sm text-lg">📄</div>
                        <h4 class="text-xs sm:text-sm font-semibold text-[#17464E]">Proses Pengajuan</h4>
                      </div>
                    ...
                    <div class="bg-[#DCEBED] p-4 sm:p-5 rounded-2xl shadow-md hover:shadow-lg transition">
                      <div class="flex items-center gap-3 mb-2">
                        ...
                        <h4 class="text-xs sm:text-sm font-semibold text-[#17464E]">Proses Verifikasi</h4>
                      </div>
                      <p class="text-xs text-[#40676f] leading-relaxed">
                    ...
                    <div class="bg-[#DCEBED] p-4 sm:p-5 rounded-2xl shadow-md hover:shadow-lg transition">
                      <div class="flex items-center gap-3 mb-2">
                        <div class="bg-white p-2 rounded-md shadow-sm text-lg">📊</div>
                        <h4 class="text-xs sm:text-sm font-semibold text-[#17464E]">Status Pengajuan</h4>
                      </div>
                      <p class="text-xs text-[#40676f] leading-relaxed">
                  ...
                  <div class="flex justify-center">
                    <Link
                      ...
                      class="flex items-center gap-2 px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-[#2f6f73] to-[#1e565a] text-white rounded-full shadow-md hover:shadow-lg transition-transform hover:scale-105 text-sm sm:text-base"
                    >
                ...
                <div v-show="activeTab === 'riwayat'" class="py-4 sm:py-6">
                  <div class="space-y-4 sm:space-y-5">
                    ...
                    >
                      ...
                      <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
                        <h2 class="text-lg sm:text-xl md:text-2xl font-bold text-[#17464E] flex-1">
                          {{ kerjasama.judul }}
                        </h2>
                        <span :class="['inline-block text-xs px-3 sm:px-4 py-1 rounded-full font-semibold whitespace-nowrap', getStatusClass(kerjasama.status)]">
                      ...
                      <div class="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center">
                          <span class="text-xs sm:text-sm text-[#40676f] font-medium w-full sm:w-40">Jenis Kerjasama</span>
                          <span class="hidden sm:inline text-xs sm:text-sm text-[#40676f] font-medium mx-4">:</span>
                          <span class="text-xs sm:text-sm font-bold text-[#17464E]">{{ kerjasama.kategori }}</span>
                        </div>
                        
                        <div class="flex flex-col sm:flex-row items-start sm:items-center">
                          <span class="text-xs sm:text-sm text-[#40676f] font-medium w-full sm:w-40">Urusan</span>
                          <span class="hidden sm:inline text-xs sm:text-sm text-[#40676f] font-medium mx-4">:</span>
                          <span class="text-xs sm:text-sm font-bold text-[#17464E]">{{ kerjasama.urusan }}</span>
                        </div>

                        <div class="flex flex-col sm:flex-row items-start sm:items-center">
                          <span class="text-xs sm:text-sm text-[#40676f] font-medium w-full sm:w-40">Tanggal Diajukan</span>
                          <span class="hidden sm:inline text-xs sm:text-sm text-[#40676f] font-medium mx-4">:</span>
                          <span class="text-xs sm:text-sm font-bold text-[#17464E]">{{ kerjasama.tanggal_daftar }}</span>
                        </div>

                        <div class="flex flex-col sm:flex-row items-start sm:items-center">
                          <span class="text-xs sm:text-sm text-[#40676f] font-medium w-full sm:w-40">Periode</span>
                          <span class="hidden sm:inline text-xs sm:text-sm text-[#40676f] font-medium mx-4">:</span>
                          <span class="text-xs sm:text-sm font-bold text-[#17464E]">{{ kerjasama.periode }}</span>
                        </div>
                      </div>

                      <!-- Lihat Progres Kerjasama Button -->
                      <div class="flex justify-center mb-4 sm:mb-6">
                        <button @click="openProgressModal(kerjasama)" class="w-full py-2 text-center text-xs sm:text-sm font-semibold text-[#2f6f73] hover:text-[#1e565a] rounded-lg transition flex items-center justify-center gap-2 bg-white/60 hover:bg-white">
    ...
    <div v-if="showLogoutConfirm" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div class="bg-white rounded-2xl p-6 sm:p-8 max-w-md w-full shadow-2xl">
        <div class="text-center">
          <div class="mx-auto flex items-center justify-center h-14 sm:h-16 w-14 sm:w-16 rounded-full bg-red-100 mb-4">
            <svg class="h-7 sm:h-8 w-7 sm:w-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
            </svg>
          </div>
          <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">Konfirmasi Keluar</h3>
          ...
          <div class="flex gap-3 justify-center">
            <button 
              @click="cancelLogout"
              class="px-4 sm:px-6 py-2 bg-gray-200 text-gray-700 rounded-lg font-semibold text-sm hover:bg-gray-300 transition"
            >
              Batal
            </button>
            <button 
              @click="handleLogout"
              class="px-4 sm:px-6 py-2 bg-red-500 text-white rounded-lg font-semibold text-sm hover:bg-red-600 transition"
            >
              Ya, Keluar
            </button>
          </div>
