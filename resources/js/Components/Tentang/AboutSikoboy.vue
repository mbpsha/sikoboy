    ...
    <section class="py-16 md:py-20 px-4 md:px-10 bg-gray-50">
        ...
        <div class="mx-auto max-w-6xl text-center mb-16 py-3">
            <p class="text-3xl sm:text-4xl md:text-2xl text-black mb-4">
                ...
                <span class="text-[#31717C] font-medium">SIKERSA</span>
            </p>
        ...
        >
            ...
            >
                <p class="text-center max-w-4xl mx-auto">
                    <strong class="text-[#17464E]">SIKERSA</strong> (Sistem
                    ...
                    sebagai sarana digital dalam mengelola arsip dokumen kerja
                    sama serta melakukan monitoring terhadap pelaksanaan kerja
                    sama yang dilakukan oleh Pemerintah Kabupaten Boyolali
                    dengan berbagai mitra.
                </p>

                <p class="text-center max-w-4xl mx-auto">
                    Pengembangan SIKERSA dilatarbelakangi oleh kebutuhan akan
                    ...
                    pencarian arsip dan pemantauan masa berlaku kerja sama
                    sering memerlukan waktu yang cukup lama.
                </p>

                <p class="text-center max-w-4xl mx-auto">
                    Melalui SIKERSA, seluruh data dan dokumen kerja sama dapat
                ...
                <p class="text-center max-w-4xl mx-auto">
                    Dengan hadirnya SIKERSA, diharapkan pengelolaan kerja sama
